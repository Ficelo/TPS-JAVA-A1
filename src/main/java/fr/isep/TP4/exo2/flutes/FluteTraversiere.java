...
public class FluteTraversiere extends InstrumentVent implements Instrument {
    ...
    public FluteTraversiere(boolean gereTrille, int qualiteAcoustique, int type, int prixAchat, int prixVente) {
        this.prixAchat = prixAchat;
        this.prixVente = prixVente;
        this.type = type;
        this.gereTrille = gereTrille;
        this.qualiteAcoustique = qualiteAcoustique;
        this.setNom("Flute traversière");
    }
